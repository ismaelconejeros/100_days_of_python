...
left_right = input('Will you turn LEFT or RIGHT?\n')

if left_right == 'right':
	print('GAME OVER, you are dead')
elif left_right == 'left':
	swim_wait = input('You found a river, will you SWIM across or will you WAIT for someone?\n')
	if swim_wait == 'swim':
		print('GAME OVER, you are dead.')
	elif swim_wait == 'wait':
		print('SOMEONE CAME! Now you have to choose between three doors, only one have the treasure.\n')
